...
export function Footer() {
  return (
    <footer className="bg-gradient-to-r from-[#0f172a] via-[#1e293b] to-[#0f172a] text-gray-200 font-inter">
      {/* Content */}
      <div className="max-w-7xl mx-auto px-6 py-14 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm">
            {" "}
            {/* ⬅️ space-y-4 for more vertical spacing */}
            <li>
              <Link
                to="/"
        ...
        <div>
          ...
          <div className="space-y-4 text-sm">
            {" "}
            {/* ⬅️ space-y-4 for same spacing as Quick Links */}
            ...
            <div className="flex items-start gap-2">
              ...
              <a
                ...
                className="hover:underline font-medium"
              >
                team@kashmirliteraturefestival.com
              </a>
            </div>
          </div>
          ...
          {/* Subscribe */}
          <div className="mt-6">
            <p className="mb-2 text-sm font-medium">Subscribe for More News</p>
      ...
      {/* Donate Banner */}
      <div className="bg-orange-600/90 text-center py-6">
        <p className="text-lg mb-3 font-medium">
          Join Us in Making a Difference – Kindly Donate Today
        </p>
        <NavLink
          to="/donation"
          className="bg-white text-orange-600 font-semibold px-6 py-2 rounded-full shadow-md hover:bg-gray-100 transition"
        >
          Donate Now
        </NavLink>
      </div>
      ...
      {/* Copyright */}
      <div className="bg-black/90 py-3 text-center text-sm text-gray-400">
        © 2024 KLF | Powered by{" "}
